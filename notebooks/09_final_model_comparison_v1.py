...
#
# The tuning is intentionally modest. The point is not to run a giant search. The point is to give each model a fair chance without turning this into a fishing expedition.
...
# ## 18) Final artifact check
#
# If everything above ran successfully, the final comparison artifacts should now exist under `../outputs/`.
#
# At that point, Phase C is effectively complete and the next work shifts to:
#
# 1. filling in `08_model_evaluation_comparison.md` with actual results  
# 2. filling in `09_model_selection_recommendation.md`  
# 3. assembling the final Assignment 2 report around the frozen artifacts
